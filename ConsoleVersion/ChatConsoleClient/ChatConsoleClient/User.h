...
private:
	...
	string email_; // почтовый ящик пользователя
...
public:
	...
	const string& getUserEmail() const { return this->email_; } /// прочитать почтовый ящик  пользователя
	void setUserEmail(const string& email) { this->email_ = email; } /// изменить почтовый ящик пользователя
};